...
public class Dashboard {
    ...
    public void updateMainTab(boolean isEnabled, String mode) {
        mainTab.getLayout("Robot Status").getEntry("Robot Enabled").setBoolean(isEnabled);
        mainTab.getLayout("Robot Status").getEntry("Robot Mode").setString(mode);
    }

    public void updateTeleopTab(boolean leftBumper, boolean rightBumper, double yAxis, double zAxis) {
